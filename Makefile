##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.7.0-B52] date: [Wed Oct 29 11:08:25 CST 2025] 
##########################################################################################################################
...
modules/encoder/encoder_spi.c \
modules/encoder/encoder_app.c \
...
# NOTE: Some older arm-none-eabi binutils do not support --no-warn-rwx-segments.
# To keep compatibility across toolchains, we omit this linker option here.
